...
\section{Work Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {XP Network Ltd.}{Remote}
      {Full Stack + Blockchain Developer}{Feb 2022 \textbf{--} Present}
        \resumeItemListStart
            \resumeItem{Worked on several Solidity smart contracts}
            \resumeItem{Currently working on a TypeScript based React codebase}
        \resumeItemListEnd
    
    \resumeSubheading
      {Feathers Studio Pvt. Ltd.}{Remote}
      {Full Stack Developer}{Oct 2021 \textbf{--} Nov 2021}
        \resumeItemListStart
            \resumeItem{Worked on an existing TypeScript based backend and React frontend}
            \resumeItem{Implemented several well-typed features and fixes into the codebase}
            \resumeItem{Also partially developed a React Native based mobile application}
        \resumeItemListEnd
    
    \resumeSubheading
      {Hexoncode Pvt. Ltd.}{Remote}
      {Backend + Android Developer}{Jan 2021 \textbf{--} Sep 2021}
        \resumeItemListStart
            \resumeItem{Created the back-end and Android application from scratch for a client}
            \resumeItem{Assisted with post-completion bug fixes over the next few months}
            \resumeItem{Back-end was in Javascript and the application was in Kotlin}
        \resumeItemListEnd
